# Historical research/CLI reference (through v0.5.x)

This page preserves the earlier bench documentation. For current product behavior use [the desktop guide](../desktop.md), [architecture](../architecture.md), and [scoring rules](../scoring.md). Old thresholds and whole-record clipping claims below do not describe v0.6.
